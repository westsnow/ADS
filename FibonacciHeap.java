...
public final class FibonacciHeap<E> implements Queue<E>
{
     ...
     */
    private final HashMap<E, FibonacciHeapNode<E>> elementsIndex = new HashMap<E, FibonacciHeapNode<E>>();
...
//        elementsIndex.add( e );
    ...
    public boolean contains( Object o )
    {
        ...
        return elementsIndex.containsKey( o );
    }
    ...
    {
        FibonacciHeapNode<E> node = elementsIndex.get(o);
        if(null == node)
        	return false;
        else
        	this.cascadingCut(node);
        return true;
    }
